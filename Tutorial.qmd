...
\textbf{What question does it answer?} Reliability Generalization Meta-Analysis addresses a ratio-based question: in which contexts is the scale relatively more informative, in the sense that a greater proportion of observed score variance reflects true differences among individuals?

\textbf{When is this the right tool?} This approach is well suited when the research question concerns the \emph{signal-to-noise ratio} of a scale across populations that are expected to differ in the spread of the underlying construct. Consider an ability test administered both to university students and to the general public. Students likely show less variation in ability than the general population. It is (used to be?) common practice to validate such a test in a sample of university students, as these are readily available. However, if a researcher wishes to apply the ability test to the sample of the general population in order to differentiate between that population's ability levels, the absolute extent of random measurement error is not of interest.
