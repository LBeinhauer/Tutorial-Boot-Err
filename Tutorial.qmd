...
**What question does it answer?** Residual invariance testing addresses a *confirmatory, model-based* question: does the measurement model hold equivalently across groups, in the sense that item-level error variances are statistically indistinguishable?z
...
| Method | Target statistic | Inference | Limitation |
|------------------|------------------|-------------------|------------------|
...
| Boot-Err | Error score variance component | Extent of differences in error score variance | ... |
