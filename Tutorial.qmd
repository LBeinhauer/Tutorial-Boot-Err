...
Techniques have been developed to inspect measuring quality beyond the proportion of random measurement error to total score variance. Measurement invariance testing attempts to do just that, modelling and assessing in how far the measuring instrument captures the same underlying latent trait.
